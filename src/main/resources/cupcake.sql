...
--
-- Current Database: `cupcakes`
--

/*!40000 DROP DATABASE IF EXISTS `cupcakes`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `cupcakes` /*!40100 DEFAULT CHARACTER SET latin1 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
--
-- Dumping routines for database 'cupcakes'
--
